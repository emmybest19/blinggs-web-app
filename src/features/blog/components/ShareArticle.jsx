const SHARE_TARGETS = [
  ...
  },
  {
    ...
    path: 'M22.675 0h-21.35c-.732 0-1.325.593-1.325 1.325v21.351c0 .73.593 1.324 1.325 1.324h11.495v-9.294h-3.13v-3.622h3.13v-2.671c0-3.1 1.893-4.788 4.659-4.788 1.325 0 2.463.099 2.795.143v3.24l-1.918.001c-1.504 0-1.796.715-1.796 1.763v2.312h3.587l-.467 3.622h-3.12v9.293h6.116c.73 0 1.324-.594 1.324-1.324v-21.35c0-.732-.594-1.325-1.324-1.325z',
  },
]
          ...
          <div className="flex items-center gap-4">
            {SHARE_TARGETS.map((target) => (
              <button
                ...
                className="flex h-12 w-12 items-center justify-center rounded-full bg-gray-100 text-gray-600 hover:bg-gray-200 transition"
              >
                <svg
                  className="h-5 w-5"
                  fill="currentColor"
