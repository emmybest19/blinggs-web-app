        ...
        <div className="relative w-full min-h-155 rounded-4xl overflow-hidden bg-linear-to-br from-[#0f1b2d] to-[#0b1220] border border-white/10 shadow-2xl flex items-center p-6 md:p-12 lg:p-16">
          ...
          <div className="hidden lg:block absolute right-12 top-1/2 -translate-y-1/2 z-20 w-80 space-y-4 pointer-events-none">
            ...
            <div className="bg-white/10 backdrop-blur-md border border-white/10 text-white p-3.5 rounded-2xl rounded-tl-none shadow-lg text-xs max-w-[240px]">
              ...
              <span className="block text-[10px] text-white/40 text-right mt-1">
                11:59
              </span>
            </div>
          </div>
          ...
          <div className="relative z-10 max-w-2xl text-white">
            ...
            <div className="flex flex-wrap gap-4 items-center">
              <button
                ...
                className="px-7 py-3.5 rounded-full bg-emerald-400 hover:bg-emerald-500 text-black font-semibold text-sm md:text-base flex items-center gap-2 transition-all active:scale-95 shadow-lg shadow-emerald-400/20"
              >
              ...
              <button
                ...
                className="px-7 py-3.5 rounded-full border border-white/30 hover:border-emerald-400 text-white font-medium text-sm md:text-base transition-all hover:bg-white/5 active:scale-95"
              >
                How it Works
              </button>
            </div>
